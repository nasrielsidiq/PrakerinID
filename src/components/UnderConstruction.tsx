...
export default function UnderConstruction() {
    return (
        <div className="fixed flex flex-col absolut w-full h-full justify-center z-10 bg-white">
            <BrainCircuit className="w-15 h-15 text-gray-500 mx-auto"/>
            <h1 className="text-accent text-center font-bold">This Page Is Under Construction</h1>
