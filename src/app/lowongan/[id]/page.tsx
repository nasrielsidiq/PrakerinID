    ...
    return (
        <>
            <section className="flex flex-col items-center text-center justify-center mt-15">
                <h1 className="text-3xl font-bold text-accent mb-5">Details Lowongan Magang</h1>
                    ...
                    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <div className="flex items-center gap-2 text-gray-600">
                                        <span className="text-blue-600 font-medium">{data && data.company.name}</span>
                                    </div>
                                    <div className="flex items-center gap-1 text-gray-500 mt-1">
                                        <MapPin className="w-4 h-4" />
                                        <span className="text-sm">{data && data.company.kota}, {data && data.company.provinsi}</span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="flex py-3 space-x-2 text-sm ">
                            ...
                            <div className="my-auto">
                                ...
                                <span>{data && dayjs(data.end_date).diff(dayjs(data.start_date), "month")} Bulan | </span>
