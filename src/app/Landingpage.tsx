                        ...
                        <div className="space-y-6  animate-slide-in-left">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 mt-8">
                                <div className="relative flex border border-gray-300 rounded-full items-center">
                                    ...
                                    <button onClick={handleSearch} className="relative bg-accent-dark w-8 h-8 ms-4 me-2 rounded-full text-white hover:bg-prakerin-dark transition-all duration-300 transform hover:scale-105 shadow-lg">
