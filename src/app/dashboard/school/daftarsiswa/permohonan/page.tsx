'use client';
import { CheckSquare, ClipboardCheck, Info, Plus, Search, UsersRound } from "lucide-react"
...
const PermohonanSiswaPage: React.FC = () => {
    ...
    return (
        <main className="p-6">
            {/* Page Header */}
            <div className="mb-6">
                <h1 className="text-accent-dark text-sm mb-5">Daftar Siswa / Permohonan Pendaftaran</h1>
                <div className="mb-8">
                        ...
                        <tbody>
                            {tasks.map((task) => (
                                <tr key={task.id} className="border-b hover:bg-gray-50">
                                    ...
                                    <td className="p-4">
                                        <button onClick={() => router.push('tasklist/tyd')} className="p-2 text-blue-600 hover:bg-blue-50 rounded-full transition-colors">
